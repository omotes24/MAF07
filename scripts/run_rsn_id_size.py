...
def main(argv: list[str] | None = None) -> int:
    ...
    output = resolve_path(args.output or f"results/quick/rsn_id_size{args.id_size}_{protocol}_results.csv")
    summary_output = resolve_path(args.summary_output or f"results/quick/rsn_id_size{args.id_size}_{protocol}_summary.csv")
