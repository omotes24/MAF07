...
export MAF07_RSN_PROFILE="${MAF07_RSN_PROFILE:-primary}"
...
export MAF07_RSN_USE_TOPQ="${MAF07_RSN_USE_TOPQ:-0}"
...
"$PYBIN" scripts/run_rsn_id_size.py --split-dir "$SPLIT_DIR" --output "$OUT" --summary-output "$SUM" --summarize-only || true
